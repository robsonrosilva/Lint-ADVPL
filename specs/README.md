...
| [002](002-correcao-e-portabilidade-include/) | Ações de correção + portabilidade de include | **Especificada, aguardando** | `spec.md` fechada, sem esclarecimento pendente. Pronta para `/speckit-plan`, mas **espera a 001 fechar** — FR-041 a FR-043 dependem do harness da US2 da 001 |
...
| ~~Portabilidade de include: caixa da referência vs arquivo no disco~~ | medição de 2026-08-19 | ✅ **na spec 002** como `PJ0001` — já falha no AppServer Linux, em silêncio |
...
| ~~Ações de correção automática~~ | — | ✅ **na spec 002** — `CA3001`, corrigir tudo e ao salvar |
